...
Let's say two years ago the estimated proportion of UVA students who flossed was 30%. Our estimate this year was 25%. Is that difference real or simply due to our random sample?
...
Let's say the true proportion of students who floss is unchanged from two years ago. It really is 30%. But we estimated 25%. What is the probability we would get a difference this big or bigger? That's the p-value. 
...
In this case, we may conclude we don't have enough evidence to confidently say that the proportion of UVA students flossing is any different than it was 10 years ago.
...
- A p-value _does not_ allow you to make a binary decision with certainty.
...
- Let's say we calculate a 95% confidence interval on the difference to be 0.05 95% CI [-0.04, 0.14].
- We're not sure if the proportion is higher or lower than it was 2 years ago. That's the conclusion.


## The analysis in R

One-sample hypothesis test. Null: proportion who floss is 0.30
...
Two-sample hypothesis test. Null: proportion has not changed in two years
...
The American Statistical Association [recommends](https://www.tandfonline.com/doi/full/10.1080/00031305.2019.1583913) the following when doing statistical inference:
...
![](tweet.jpg)
<br><br><br>
Note: RR = "Risk Ratio", another way to compare two proportions. A ratio of 1 implies "no difference".